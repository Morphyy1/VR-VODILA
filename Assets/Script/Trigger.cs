    ...
    private void OnTriggerEnter(Collider other)
    {
        switch(other.gameObject.tag)
        {
            case "Snake":
                ...
                TutorialUI.instance.SwitchToNextTutorial(TutorialUI.instance.uTurnSprites);
                break;  
            case "Rotation 1":
            ...
            case "Rotation 2":
                ...
                TutorialUI.instance.SwitchToNextTutorial(TutorialUI.instance.r2Sprites);
                break;
            case "Traffic":
                TutorialUI.instance.SwitchToNextTutorial(TutorialUI.instance.trafficLightSprites);
                if (!GreenLight.enabled)
                    IsPlayesCollision();
                break;
            case "Garage":
                SetCurrentPosition(83.85f, 1.772f, -114.34f);
                TutorialUI.instance.SwitchToNextTutorial(TutorialUI.instance.garageSprites);
                break;
            case "Hill":
                SetCurrentPosition(68.33f, 1.772f, -145.27f);
                TutorialUI.instance.SwitchToNextTutorial(TutorialUI.instance.hillSprites);
                break;
            case "Free":
                SetCurrentPosition(-16.21f, 1.772f, -123.56f);
                SetCurrentAngle(0, 0, 0);
                TutorialUI.instance.SwitchToNextTutorial(TutorialUI.instance.freeMovementSprites);
                break;
            case "StopLine":
                IsPlayesCollision();
                break;
